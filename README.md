...
- 1.20.0.8版本（也就是在测试项内选无）可以正常使用，其他版本默认部分兼容

- `words.json` 已添加完整汉化文本.(正在更新1.20.0.8完成机翻，等待润化)

- `nodes.json` 已添加完整汉化文本(正在更新1.20.0.8完成机翻，等待润化).

- 示例教程汉化 1.19.0.11之前的教程已添加完整汉化文本(1.20.0.8的教程等待汉化).
