...
- 1.21.4版本（也就是在测试项内选无）不可以正常使用，其他版本默认部分兼容

- `words.json` 已添加完整汉化文本.(1.21.4完成AI机翻，等待润化)

- `nodes.json` 已添加完整汉化文本(1.21.4完成AI机翻，等待润化).

- 示例教程汉化 1.19.0.11之前的教程已添加完整汉化文本(1.21.4的教程等待汉化).
